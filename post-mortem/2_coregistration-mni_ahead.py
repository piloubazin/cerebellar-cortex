...
inpath = '/home/public/InSitu/Processed/insitu_08_122017_xx_xx/release/'
outdir = '/home/pilou/Projects/Cerebellum/Cerebellar-segmentation-ABC/ahead/coreg/'


bf_img = inpath+'Ahead_brain_122017_blockface-image.nii.gz'
thio_img = inpath+'Ahead_brain_122017_thionin-interpolated.nii.gz'
parv_img = inpath+'Ahead_brain_122017_parvalbumin-interpolated.nii.gz'
silv_img = inpath+'Ahead_brain_122017_Bieloschowsky-interpolated.nii.gz'
...
mni09b2bf = inpath+'mni2009b/Ahead_brain_122017_mapping-mni2009b2blockface.nii.gz'
