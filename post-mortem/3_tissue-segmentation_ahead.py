...
indir = '/home/pilou/Projects/Cerebellum/Cerebellar-segmentation-ABC/ahead/coreg/'
outdir = '/home/pilou/Projects/Cerebellum/Cerebellar-segmentation-ABC/ahead/tissues/'

#bfimg = indir+'Ahead_brain_122017_blockface-image_cr_def-img.nii.gz'
thio = indir+'Ahead_brain_122017_thionin-interpolated_cr_def-img.nii.gz'
#parv = indir+'Ahead_brain_122017_parvalbumin-interpolated_cr_def-img.nii.gz'
silv = indir+'Ahead_brain_122017_Bieloschowsky-interpolated_cr_def-img.nii.gz'

cbprior = indir+'Ahead_brain_122017_blockface-image_cr_cbmask_def-img.nii.gz'
cbwmprior = indir+'Ahead_brain_122017_blockface-image_cr_cbwmmask_def-img.nii.gz'
